    ...
    <div className="min-h-screen bg-background">
      <div className="border-b border-border bg-gradient-to-br from-primary/5 to-primary/10">
        <div className="container mx-auto px-4 py-16">
          <h1 className="mb-4 text-4xl font-bold md:text-5xl">Podcasts</h1>
          <p className="mb-8 text-lg text-muted-foreground md:text-xl">
            Ouve conversas sobre financas pessoais, investimentos e muito mais
          </p>
            ...
            <Card className="p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <select
                    value={((filters as Record<string, unknown>).frequency as string) || ''}
                    onChange={(e) =>
                      setFilters(
                        (prev) =>
                          ({
                            ...prev,
                            frequency: e.target.value || undefined,
                          }) as ContentFilters,
                      )
                    }
                    className="w-full rounded-lg border border-input bg-transparent px-3 py-2 text-sm"
          ...
          <div>
            <div className="mb-4 flex items-center justify-between">
              <h2 className="text-xl font-semibold">
                {data?.total || 0} {data?.total === 1 ? 'Podcast' : 'Podcasts'}
              </h2>
            </div>
