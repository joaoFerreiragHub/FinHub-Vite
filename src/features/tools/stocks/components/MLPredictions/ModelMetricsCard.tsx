        ...
        <CardContent className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-white rounded-lg p-4 border border-gray-100">
              ...
              <div
                className={`text-2xl font-bold ${getConfidenceColor(data.modelMetrics.earnings.accuracy)}`}
              >
            ...
            <div className="bg-white rounded-lg p-4 border border-gray-100">
              ...
              <div
                className={`text-2xl font-bold ${getConfidenceColor(data.modelMetrics.price.accuracy)}`}
              >
          ...
          {data.analytics?.dataQuality && (
            <div className="bg-white rounded-lg p-4 border border-gray-100">
              <div className="flex justify-between items-center mb-2">
                ...
                <span
                  className={`font-medium ${getConfidenceColor(data.analytics.dataQuality * 100)}`}
                >
