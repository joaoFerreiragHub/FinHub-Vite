...
import { EarningsOnly, MLPredictions } from '@/features/tools/stocks/types/mlPredictions'
...
export function useMLPredictionsRealTime(
  ...
  const { autoReconnect = true, reconnectDelay = 5000, onConnect, onDisconnect, onError } = options
