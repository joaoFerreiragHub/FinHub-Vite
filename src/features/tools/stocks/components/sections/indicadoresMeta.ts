...
export const indicadoresMetaTech: IndicadorMeta[] = [
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        ...
        if (delta > 2)
          return `Aumento significativo em P&D (+${delta.toFixed(1)}pp) pode indicar investimento em inovação.`
        if (delta < -2)
          return `Redução em P&D (${delta.toFixed(1)}pp) pode comprometer competitividade futura.`
      }
      if (!isNaN(atual)) {
        if (atual > 15)
          return 'P&D muito alto pode indicar sector intensivo em pesquisa ou startup.'
        if (atual < 3)
          return 'P&D baixo pode ser adequado para empresas maduras com produtos estabelecidos.'
      }
      return ''
    },
  },
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v > 2)
          return 'Eficiência de P&D excelente - cada euro investido gera bom retorno em crescimento.'
        if (v < 0.5)
          return 'Baixa eficiência de P&D pode indicar má gestão dos investimentos em inovação.'
      }
      return ''
    },
  },
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual)) {
        if (atual > 50)
          return 'ROIC elevado (>50%) pode refletir eventos não recorrentes. Verifica consistência.'
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 50000000)
          return `FCF melhorou significativamente (+${(delta / 1000000).toFixed(0)}M). Boa geração de caixa.`
        if (delta < -50000000)
          return `FCF deteriorou (${(delta / 1000000).toFixed(0)}M). Pode indicar investimentos pesados.`
      }
      if (!isNaN(atual)) {
        if (atual > 0)
          return 'FCF positivo indica geração saudável de caixa após investimentos operacionais.'
        if (atual < 0)
          return 'FCF negativo pode indicar fase de investimento ou dificuldades operacionais.'
      }
      return ''
    },
  },
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v > 1.5)
          return 'Beta alto indica maior volatilidade que o mercado - típico em growth stocks.'
        if (v < 0.8)
          return 'Beta baixo sugere menor volatilidade - pode indicar empresa mais madura.'
      }
      return ''
    },
  },
  ...
  // 🆕 NOVO: Receitas Recorrentes como indicador
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v > 50)
          return 'Alto percentual de receitas recorrentes indica modelo de negócio previsível.'
        if (v > 20) return 'Receitas recorrentes moderadas proporcionam alguma previsibilidade.'
        if (v === 0)
          return 'Sem receitas recorrentes - típico de empresas não-SaaS ou produtos únicos.'
      }
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual)) {
        if (atual > 50)
          return 'ROIC elevado (>50%) pode refletir eventos não recorrentes. Verifica consistência.'
        if (atual > 30)
          return 'ROIC muito elevado pode refletir ganhos pontuais. Confirma se é consistente.'
      }
      return ''
    },
  },
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v > 0)
          return 'FCF positivo indica geração saudável de caixa após investimentos operacionais.'
        if (v < 0)
          return 'FCF negativo pode indicar investimentos pesados ou dificuldades em gerar caixa.'
      }
      return ''
    },
  },
...
export const indicadoresMetaReits: IndicadorMeta[] = [
  // === RENTABILIDADE E DIVIDENDOS ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        ...
        if (delta < -1)
          return `Yield diminuiu ${Math.abs(delta).toFixed(1)}pp. Pode indicar corte ou apreciação do preço.`
      }
      if (!isNaN(atual)) {
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v > 90)
          return 'FFO Payout muito alto limita crescimento e pode comprometer sustentabilidade.'
  ...
  // === MÚLTIPLOS ESPECÍFICOS ===
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        ...
        if (v > 1.5)
          return 'P/VPA alto pode indicar sobrevalorização ou expectativas de crescimento.'
      }
  ...
  // === OPERACIONAIS ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 3)
          return `Margem EBITDA melhorou ${delta.toFixed(1)}pp. Indica eficiência operacional.`
        if (delta < -3)
          return `Margem EBITDA caiu ${Math.abs(delta).toFixed(1)}pp. Pode indicar pressão de custos.`
      }
      if (!isNaN(atual)) {
  ...
  // === FLUXO DE CAIXA ESPECÍFICO ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        ...
        if (delta > 10)
          return `FFO cresceu ${delta.toFixed(1)}%. Indica melhoria operacional sólida.`
        if (delta < -10)
          return `FFO caiu ${Math.abs(delta).toFixed(1)}%. Pode comprometer dividendos.`
      }
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 3)
          return `ROE melhorou ${delta.toFixed(1)}pp - fortalecimento da rentabilidade defensiva.`
        if (delta < -3)
          return `ROE deteriorou ${delta.toFixed(1)}pp - pode indicar pressão competitiva.`
      }
      if (!isNaN(atual)) {
  ...
  // === MARGENS E EFICIÊNCIA ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 2)
          return `Margem bruta melhorou ${delta.toFixed(1)}pp - pode indicar pricing power.`
        if (delta < -2)
          return `Margem bruta deteriorou ${delta.toFixed(1)}pp - pressão competitiva ou custos.`
      }
      if (!isNaN(atual)) {
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 2)
          return `Margem EBITDA melhorou ${delta.toFixed(1)}pp - operações mais eficientes.`
        if (delta < -2)
          return `Margem EBITDA deteriorou ${delta.toFixed(1)}pp - pressão operacional.`
      }
      if (!isNaN(atual)) {
  ...
  // === CRESCIMENTO E ESTABILIDADE ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 3)
          return `Crescimento acelerou ${delta.toFixed(1)}pp - pode indicar expansão ou ganho de mercado.`
        if (delta < -3)
          return `Crescimento desacelerou ${Math.abs(delta).toFixed(1)}pp - pressão competitiva ou maturidade.`
      }
      if (!isNaN(atual)) {
  ...
  // === FLUXO DE CAIXA E EFICIÊNCIA ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 20000000)
          return `FCF melhorou significativamente (+${(delta / 1000000).toFixed(0)}M). Sustenta dividendos.`
        if (delta < -20000000)
          return `FCF deteriorou (${(delta / 1000000).toFixed(0)}M). Pode pressionar dividendos.`
      }
      if (!isNaN(atual)) {
  ...
  // === DIVIDENDOS E RETORNO DEFENSIVO ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 10)
          return `Payout aumentou ${delta.toFixed(1)}pp - pode pressionar sustentabilidade.`
        if (delta < -10)
          return `Payout reduziu ${Math.abs(delta).toFixed(1)}pp - maior conservadorismo.`
      }
      if (!isNaN(atual)) {
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 1)
          return `Dividend Yield aumentou ${delta.toFixed(1)}pp - pode indicar aumento de dividendos ou queda de preço.`
        if (delta < -1)
          return `Dividend Yield reduziu ${Math.abs(delta).toFixed(1)}pp - pode indicar corte ou valorização.`
      }
      if (!isNaN(atual)) {
  ...
  // === VOLATILIDADE E AVALIAÇÃO ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta < -0.2)
          return `Beta reduziu ${Math.abs(delta).toFixed(2)} - menor volatilidade, mais defensivo.`
        if (delta > 0.2)
          return `Beta aumentou ${delta.toFixed(2)} - maior volatilidade, menos defensivo.`
      }
      if (!isNaN(atual)) {
        if (atual < 0.8) return 'Beta baixo confirma natureza defensiva e baixa volatilidade.'
        if (atual > 1.2)
          return 'Beta alto pode indicar exposição cíclica inesperada para setor defensivo.'
      }
      return ''
    },
  },
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        ...
        if (delta < -5)
          return `Redução de ${Math.abs(delta).toFixed(1)}% pode indicar otimização ou dificuldades.`
      }
      if (!isNaN(atual)) {
...
export const indicadoresMetaFinancials: IndicadorMeta[] = [
  // === RENTABILIDADE E EFICIÊNCIA (UNIVERSAL) ===
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v > 25)
          return 'ROE excepcional indica gestão premium e modelo de negócio defensivo (típico de payment processors).'
        if (v > 18)
          return 'ROE excelente indica gestão muito eficaz do patrimônio e alavancagem otimizada.'
        if (v < 10)
          return 'ROE baixo pode indicar ineficiências operacionais ou ambiente competitivo intenso.'
      }
      return ''
    },
  },
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        ...
        if (v < 0.8)
          return 'ROA baixo sugere baixa produtividade dos ativos ou problemas operacionais.'
      }
      return ''
    },
  },
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v < 35)
          return 'Eficiência excepcional indica operação altamente otimizada (típico de fintechs).'
        if (v < 45)
          return 'Eficiência excelente para bancos tradicionais com controle rigoroso de custos.'
        if (v > 65)
          return 'Eficiência baixa sugere estrutura de custos elevada ou baixa produtividade.'
      }
      return ''
    },
  },
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v > 20)
          return 'Margem excepcional típica de payment processors com modelo de receita premium.'
        if (v > 4.5)
          return 'Margem financeira forte para bancos indica pricing power e mix favorável.'
        if (v < 3)
          return 'Margem baixa pode indicar pressão competitiva ou ambiente de juros desfavorável.'
      }
      return ''
    },
  },
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v > 30)
          return 'Margem excepcional indica modelo de negócio premium com forte pricing power.'
        if (v > 20)
          return 'Margem forte típica de empresas com vantagens competitivas sustentáveis.'
        if (v < 10)
          return 'Margem baixa pode indicar pressão competitiva ou necessidade de eficiência.'
      }
      return ''
    },
  },
  ...
  // === SOLIDEZ E CAPITALIZAÇÃO (BANCOS) ===
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        ...
        if (v < 11.5)
          return 'Próximo ao mínimo regulatório, limitando flexibilidade para crescimento.'
      }
      return ''
    },
  },
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v > 12)
          return 'Capital principal robusto oferece excelente capacidade de absorção de perdas.'
  ...
  // === ESTRUTURA DE CAPITAL E LIQUIDEZ (UNIVERSAL) ===
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        ...
        if (v < 1)
          return 'Alavancagem muito baixa típica de payment processors com balanços eficientes.'
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v > 1.8)
          return 'Beta alto indica maior sensibilidade a ciclos econômicos e stress financeiro.'
        if (v < 0.8)
          return 'Beta baixo sugere maior estabilidade vs. mercado (típico de utilities financeiras).'
  ...
  // === GESTÃO DE RISCO (BANCOS) ===
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v < 2)
          return 'Taxa baixa indica excelente qualidade da carteira e políticas de crédito rigorosas.'
        if (v > 4)
          return 'Taxa elevada sugere deterioração da qualidade de crédito ou ciclo econômico adverso.'
      }
      return ''
    },
  },
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        ...
        if (v < 100)
          return 'Cobertura insuficiente pode expor o banco a perdas em cenários adversos.'
      }
      return ''
    },
  },
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v < 1.5)
          return 'Custo baixo indica políticas de crédito conservadoras e boa seleção de clientes.'
  ...
  // === MÚLTIPLOS DE AVALIAÇÃO (UNIVERSAL) ===
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v > 25)
          return 'P/L alto típico de growth stocks ou empresas com modelos defensivos (payment processors).'
        if (v < 8) return 'P/L baixo pode indicar oportunidade ou expectativas de deterioração.'
        if (v > 18 && v < 25)
          return 'P/L elevado mas pode ser justificado por qualidade superior dos ativos.'
      }
      return ''
    },
  },
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        ...
        if (v > 2.5 && v < 5)
          return 'P/VPA elevado mas justificável para empresas de alta qualidade.'
      }
      return ''
    },
  },
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        ...
        if (v < 30)
          return 'Payout baixo oferece flexibilidade para crescimento e fortalecimento patrimonial.'
        if (v >= 30 && v <= 50)
          return 'Payout equilibrado entre distribuição e retenção de capital.'
      }
      return ''
    },
  },
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        ...
        if (v < 5)
          return 'Crescimento baixo pode indicar ambiente competitivo ou políticas restritivas.'
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v > 15)
          return 'Crescimento forte indica expansão bem-sucedida e captura de market share.'
        if (v < 5)
          return 'Crescimento baixo pode indicar maturidade do mercado ou pressão competitiva.'
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        ...
        if (v < 65)
          return 'Qualidade abaixo da média sugere necessidade de melhores políticas de risco.'
      }
      return ''
    },
  },
...
export const indicadoresMetaIndustrials: IndicadorMeta[] = [
  ...
  // === ESTRUTURA FINANCEIRA ===
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v > 4)
          return 'Alavancagem alta aumenta risco financeiro, especialmente em ciclos econômicos.'
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v < 0.8)
          return 'PEG baixo sugere oportunidade de valorização considerando o crescimento.'
  ...
  // === FLUXO DE CAIXA ===
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        ...
        if (v < 0)
          return 'FCF negativo pode indicar fase de investimento intenso ou problemas operacionais.'
      }
      return ''
    },
  },
...
export const indicadoresMetaEnergy: IndicadorMeta[] = [
  // === RENTABILIDADE E RETORNO ===
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v < 8)
          return 'P/L baixo pode indicar oportunidade ou expectativas de queda nos preços de commodities.'
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 5)
          return `ROE melhorou ${delta.toFixed(1)}pp - pode refletir ambiente de preços favorável.`
        if (delta < -5)
          return `ROE deteriorou ${delta.toFixed(1)}pp - pode indicar pressão de commodities.`
      }
      if (!isNaN(atual)) {
        if (atual > 15) return 'ROE forte indica gestão eficaz em ambiente de commodities voláteis.'
        if (atual < 8)
          return 'ROE baixo pode refletir ambiente de preços desfavorável ou ineficiências.'
      }
      return ''
    },
  },
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 3)
          return `ROIC melhorou ${delta.toFixed(1)}pp - indica eficiência crescente na alocação de capital.`
        if (delta < -3)
          return `ROIC deteriorou ${delta.toFixed(1)}pp - pode indicar pressão nos retornos.`
      }
      if (!isNaN(atual)) {
        if (atual > 12)
          return 'ROIC excelente demonstra alocação eficiente de capital em setor intensivo.'
  ...
  // === MARGENS E EFICIÊNCIA ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 5)
          return `Margem EBITDA melhorou ${delta.toFixed(1)}pp - indica controle de custos ou preços favoráveis.`
        if (delta < -5)
          return `Margem EBITDA deteriorou ${delta.toFixed(1)}pp - pressão de custos ou preços.`
      }
      if (!isNaN(atual)) {
        if (atual > 30) return 'Margem EBITDA forte indica controle de custos e pricing power.'
        if (atual < 20)
          return 'Margem baixa pode indicar pressão de custos ou preços desfavoráveis.'
      }
      return ''
    },
  },
  ...
  // === ESTRUTURA DE CAPITAL E SOLVÊNCIA ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta < -0.5)
          return `Endividamento reduziu ${Math.abs(delta).toFixed(1)}x - fortalecimento da estrutura financeira.`
        if (delta > 0.5)
          return `Endividamento aumentou ${delta.toFixed(1)}x - pode indicar novos investimentos ou stress.`
      }
      if (!isNaN(atual)) {
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 1)
          return `Cobertura melhorou ${delta.toFixed(1)}x - maior segurança financeira.`
        if (delta < -1)
          return `Cobertura deteriorou ${Math.abs(delta).toFixed(1)}x - pode indicar pressão de EBITDA.`
      }
      if (!isNaN(atual)) {
  ...
  // === FLUXO DE CAIXA E INVESTIMENTOS ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 100000000)
          return `FCF melhorou significativamente (+${(delta / 1000000).toFixed(0)}M). Excelente geração de caixa.`
        if (delta < -100000000)
          return `FCF deteriorou (${(delta / 1000000).toFixed(0)}M). Pode indicar CapEx elevado ou pressão operacional.`
      }
      if (!isNaN(atual)) {
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 5)
          return `CapEx aumentou ${delta.toFixed(1)}pp - pode indicar ciclo de investimentos.`
        if (delta < -5)
          return `CapEx reduziu ${Math.abs(delta).toFixed(1)}pp - pode liberar mais FCF.`
      }
      if (!isNaN(atual)) {
  ...
  // === MÉTRICAS ESPECÍFICAS DE ENERGIA ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = ((atual - anterior) / anterior) * 100
        if (delta > 10)
          return `Reservas aumentaram ${delta.toFixed(1)}% - expansão da base de recursos.`
        if (delta < -10)
          return `Reservas reduziram ${Math.abs(delta).toFixed(1)}% - pode indicar depleção ou reclassificação.`
      }
      if (!isNaN(atual)) {
        if (atual > 0)
          return 'Reservas provadas garantem sustentabilidade operacional de longo prazo.'
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta < -5)
          return `Custo reduziu $${Math.abs(delta).toFixed(2)}/barril - melhoria na eficiência operacional.`
        if (delta > 5)
          return `Custo aumentou $${delta.toFixed(2)}/barril - pode pressionar margens.`
      }
      if (!isNaN(atual)) {
        if (atual < 40) return 'Custo baixo oferece vantagem competitiva e margens robustas.'
        if (atual > 70)
          return 'Custo alto pode pressionar rentabilidade em cenários de preços baixos.'
      }
      return ''
    },
  },
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta < -5)
          return `Break-even melhorou $${Math.abs(delta).toFixed(2)}/barril - maior competitividade.`
        if (delta > 5)
          return `Break-even deteriorou $${delta.toFixed(2)}/barril - pode indicar pressão de custos.`
      }
      if (!isNaN(atual)) {
  ...
  // === RENTABILIDADE E RETORNO ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta < -3)
          return `P/L reduziu ${Math.abs(delta).toFixed(1)}x - pode indicar oportunidade cíclica.`
        if (delta > 3)
          return `P/L aumentou ${delta.toFixed(1)}x - pode indicar sobrevalorização no ciclo.`
      }
      if (!isNaN(atual)) {
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        ...
        if (delta < -5)
          return `ROE deteriorou ${Math.abs(delta).toFixed(1)}pp - pressão do downturn.`
      }
      if (!isNaN(atual)) {
  ...
  // === MARGENS E EFICIÊNCIA ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 3)
          return `Margem bruta melhorou ${delta.toFixed(1)}pp - pricing power ou eficiência.`
        if (delta < -3)
          return `Margem bruta deteriorou ${Math.abs(delta).toFixed(1)}pp - pressão competitiva.`
      }
      if (!isNaN(atual)) {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        ...
        if (delta > 2)
          return `Margem EBITDA melhorou ${delta.toFixed(1)}pp - operações mais eficientes.`
        if (delta < -2)
          return `Margem EBITDA deteriorou ${Math.abs(delta).toFixed(1)}pp - pressão operacional.`
      }
      if (!isNaN(atual)) {
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 2)
          return `Margem líquida melhorou ${delta.toFixed(1)}pp - beneficiando do upturn.`
        if (delta < -2)
          return `Margem líquida deteriorou ${Math.abs(delta).toFixed(1)}pp - impacto do downturn.`
      }
      if (!isNaN(atual)) {
  ...
  // === CRESCIMENTO E PERFORMANCE CÍCLICA ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 5)
          return `CAGR acelerou ${delta.toFixed(1)}pp - ganho de market share ou upturn.`
        if (delta < -5)
          return `CAGR desacelerou ${Math.abs(delta).toFixed(1)}pp - pressão competitiva ou ciclo.`
      }
      if (!isNaN(atual)) {
        if (atual > 8) return 'CAGR forte demonstra crescimento consistente através dos ciclos.'
        if (atual < 3)
          return 'Crescimento baixo pode indicar maturidade ou perda de competitividade.'
      }
      return ''
    },
  },
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        ...
        if (delta < -10)
          return `Crescimento desacelerou ${Math.abs(delta).toFixed(1)}pp - início de downturn.`
      }
      if (!isNaN(atual)) {
  ...
  // === ESTRUTURA DE CAPITAL E SOLVÊNCIA ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta < -0.5)
          return `Endividamento reduziu ${Math.abs(delta).toFixed(1)}x - fortalecimento financeiro.`
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        ...
        if (delta > 2)
          return `Cobertura melhorou ${delta.toFixed(1)}x - maior segurança financeira.`
        if (delta < -2)
          return `Cobertura deteriorou ${Math.abs(delta).toFixed(1)}x - risco crescente.`
      }
      if (!isNaN(atual)) {
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        ...
        if (delta < -0.3)
          return `Liquidez deteriorou ${Math.abs(delta).toFixed(2)} - pressão de caixa.`
      }
      if (!isNaN(atual)) {
  ...
  // === EFICIÊNCIA OPERACIONAL ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        ...
        if (delta < -1)
          return `Giro deteriorou ${Math.abs(delta).toFixed(1)}x - acúmulo de estoques.`
      }
      if (!isNaN(atual)) {
  ...
  // === FLUXO DE CAIXA ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 50000000)
          return `FCF melhorou significativamente (+${(delta / 1000000).toFixed(0)}M). Fortalece posição cíclica.`
        if (delta < -50000000)
          return `FCF deteriorou (${(delta / 1000000).toFixed(0)}M). Pressão no downturn.`
      }
      if (!isNaN(atual)) {
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 2)
          return `CapEx aumentou ${delta.toFixed(1)}pp - investindo para o próximo ciclo.`
  ...
  // === DIVIDENDOS E RETORNO ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 1)
          return `Dividend Yield aumentou ${delta.toFixed(1)}pp - pode indicar stress ou oportunidade.`
        if (delta < -1)
          return `Dividend Yield reduziu ${Math.abs(delta).toFixed(1)}pp - possível corte ou valorização.`
      }
      if (!isNaN(atual)) {
  ...
  // === VOLATILIDADE E AVALIAÇÃO ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta < -0.3)
          return `Beta reduziu ${Math.abs(delta).toFixed(2)} - menor sensibilidade cíclica.`
  ...
  // === MÉTRICAS ESPECÍFICAS DE CONSUMER CYCLICAL ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        ...
        if (delta < -2)
          return `Market share perdeu ${Math.abs(delta).toFixed(1)}pp - pressão competitiva.`
      }
      if (!isNaN(atual)) {
...
export const indicadoresMetaBasicMaterials: IndicadorMeta[] = [
  // === RENTABILIDADE E RETORNO ===
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v < 8)
          return 'P/E baixo pode indicar oportunidade ou expectativas de queda nos preços de commodities.'
        if (v > 25)
          return 'P/E alto pode indicar sobrevalorização para setor cíclico de materiais básicos.'
      }
      return ''
    },
  },
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 5)
          return `ROE melhorou ${delta.toFixed(1)}pp - pode refletir ciclo favorável de preços.`
        if (delta < -5)
          return `ROE deteriorou ${delta.toFixed(1)}pp - pressão de commodities ou custos.`
      }
      if (!isNaN(atual)) {
        if (atual > 15) return 'ROE forte indica gestão eficaz em setor cíclico de materiais.'
        if (atual < 8)
          return 'ROE baixo pode refletir ciclo desfavorável ou ineficiências operacionais.'
      }
      return ''
    },
  },
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 3)
          return `ROIC melhorou ${delta.toFixed(1)}pp - eficiência crescente na alocação de capital.`
        if (delta < -3)
          return `ROIC deteriorou ${delta.toFixed(1)}pp - pressão nos retornos do capital.`
      }
      if (!isNaN(atual)) {
        if (atual > 12)
          return 'ROIC excelente demonstra uso eficiente de capital em setor intensivo.'
        if (atual < 8) return 'ROIC baixo indica retornos insuficientes vs. custo de capital.'
      }
      return ''
    },
  ...
  // === MARGENS E EFICIÊNCIA ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 5)
          return `Margem EBITDA melhorou ${delta.toFixed(1)}pp - controle de custos ou preços favoráveis.`
        if (delta < -5)
          return `Margem EBITDA deteriorou ${delta.toFixed(1)}pp - pressão de custos ou preços.`
      }
      if (!isNaN(atual)) {
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        ...
        if (v < 8)
          return 'Margem operacional baixa pode indicar ineficiências ou pressão competitiva.'
      }
      return ''
    },
  },
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        ...
        if (delta < -0.5)
          return `Endividamento reduziu ${Math.abs(delta).toFixed(1)}x - fortalecimento financeiro.`
        if (delta > 0.5)
          return `Endividamento aumentou ${delta.toFixed(1)}x - pode indicar investimentos ou stress.`
      }
      if (!isNaN(atual)) {
  ...
  // === FLUXO DE CAIXA E EFICIÊNCIA DE CAPITAL ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 50000000)
          return `FCF melhorou significativamente (+${(delta / 1000000).toFixed(0)}M). Forte geração de caixa.`
        if (delta < -50000000)
          return `FCF deteriorou (${(delta / 1000000).toFixed(0)}M). Pode indicar CapEx elevado.`
      }
      if (!isNaN(atual)) {
  ...
  // === CRESCIMENTO E PERFORMANCE ===
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v > 15)
          return 'Crescimento forte pode indicar expansão de mercado ou preços favoráveis.'
  ...
  // === MÉTRICAS ESPECÍFICAS DE BASIC MATERIALS ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 1)
          return `Giro de inventário melhorou ${delta.toFixed(1)}x - gestão mais eficiente.`
        if (delta < -1)
          return `Giro deteriorou ${Math.abs(delta).toFixed(1)}x - pode indicar excesso de estoque.`
      }
      if (!isNaN(atual)) {
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 5)
          return `Utilização aumentou ${delta.toFixed(1)}pp - demanda crescente ou otimização.`
        if (delta < -5)
          return `Utilização reduziu ${Math.abs(delta).toFixed(1)}pp - pode indicar demanda fraca.`
      }
      if (!isNaN(atual)) {
...
export const indicadoresMetaUtilities: IndicadorMeta[] = [
  // === MÚLTIPLOS DE VALUATION ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 3)
          return `P/L aumentou ${delta.toFixed(1)}x. Pode indicar deterioração dos lucros ou aumento das expectativas.`
        if (delta < -3)
          return `P/L diminuiu ${Math.abs(delta).toFixed(1)}x. Pode indicar melhoria dos lucros ou pessimismo excessivo.`
      }

      if (!isNaN(atual)) {
        if (atual < 10)
          return 'P/L muito baixo para utility pode indicar oportunidade ou problemas regulatórios sérios.'
        if (atual > 25)
          return 'P/L alto pode indicar expectativas de crescimento ou mercado sobreaquecido.'
        if (atual >= 12 && atual <= 18)
          return 'P/L dentro da faixa típica para utilities bem geridas.'
      }
      return ''
    },
  },
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v < 0.8)
          return 'P/VPA muito baixo pode indicar subvalorização ou problemas fundamentais.'
        if (v > 2.0)
          return 'P/VPA alto para utility. Verificar se é justificado pelo ROE e qualidade dos ativos.'
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v > 8)
          return 'Earnings yield alto sugere utility subvalorizada ou riscos elevados. Compare com yields de bonds.'
        if (v < 4)
          return 'Earnings yield baixo pode indicar sobrevalorização ou expectativas muito otimistas.'
  ...
  // === RENTABILIDADE ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 3)
          return `ROE melhorou ${delta.toFixed(1)}pp. Excelente evolução na eficiência do capital.`
        if (delta < -3)
          return `ROE deteriorou ${Math.abs(delta).toFixed(1)}pp. Investigar causas: regulação, custos ou alavancagem.`
      }

      if (!isNaN(atual)) {
        if (atual > 15)
          return 'ROE excelente para utility indica gestão eficiente do capital e ambiente regulatório favorável.'
        if (atual < 8)
          return 'ROE baixo pode refletir ambiente regulatório restritivo ou ineficiência operacional.'
        if (atual >= 10 && atual <= 14)
          return 'ROE sólido dentro da faixa esperada para utilities de qualidade.'
      }
      return ''
    },
  },
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 2)
          return `ROIC melhorou ${delta.toFixed(1)}pp. Boa eficiência na alocação de capital em infraestrutura.`
        if (delta < -2)
          return `ROIC deteriorou ${Math.abs(delta).toFixed(1)}pp. Pode indicar novos investimentos ainda não produtivos.`
      }

      if (!isNaN(atual)) {
        if (atual > 10)
          return 'ROIC sólido indica excelente eficiência na alocação de capital em infraestrutura.'
        if (atual < 5)
          return 'ROIC baixo pode indicar regulamentação restritiva ou investimentos ineficientes.'
        if (atual >= 7 && atual <= 9)
          return 'ROIC adequado para utilities com investimentos contínuos em infraestrutura.'
      }
      return ''
    },
  },
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v > 12)
          return 'ROE regulatório alto indica ambiente favorável e boa relação com o regulador.'
  ...
  // === DIVIDENDOS E DISTRIBUIÇÕES (CORE para Utilities) ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 1)
          return `Yield aumentou ${delta.toFixed(1)}pp. Analisar se é por queda no preço ou aumento do dividendo.`
        if (delta < -1)
          return `Yield diminuiu ${Math.abs(delta).toFixed(1)}pp. Pode indicar valorização ou corte nos dividendos.`
      }

      if (!isNaN(atual)) {
        if (atual > 8)
          return 'Yield muito alto pode indicar risco de corte ou stress financeiro. Verificar sustentabilidade.'
        if (atual < 2.5)
          return 'Yield baixo pode indicar crescimento forte ou sobrevalorização da ação.'
        if (atual >= 3.5 && atual <= 6)
          return 'Yield atrativo dentro da faixa típica para utilities de qualidade.'
      }
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 10)
          return `Payout aumentou ${delta.toFixed(1)}pp. Monitorar sustentabilidade dos dividendos.`
        if (delta < -10)
          return `Payout diminuiu ${Math.abs(delta).toFixed(1)}pp. Pode indicar conservadorismo ou necessidade de investimentos.`
      }

      if (!isNaN(atual)) {
        if (atual > 90)
          return 'Payout muito alto pode comprometer sustentabilidade e capacidade de crescimento.'
        if (atual < 50)
          return 'Payout conservador proporciona excelente margem de segurança para dividendos.'
        if (atual >= 60 && atual <= 80)
          return 'Payout equilibrado permite crescimento dos dividendos e reinvestimento.'
      }
      return ''
    },
  },
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v > 95)
          return 'Histórico excelente de pagamentos - alta previsibilidade para investidores de renda.'
  ...
  // === ESTRUTURA FINANCEIRA ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 10)
          return `Endividamento aumentou ${delta.toFixed(1)}pp. Monitorar capacidade de pagamento.`
        if (delta < -10)
          return `Endividamento diminuiu ${Math.abs(delta).toFixed(1)}pp. Redução de risco financeiro.`
      }

      if (!isNaN(atual)) {
        if (atual > 70)
          return 'Endividamento elevado mesmo para utility - aumenta risco financeiro e sensibilidade a juros.'
        if (atual < 40)
          return 'Endividamento conservador pode limitar crescimento mas reduz risco significativamente.'
        if (atual >= 50 && atual <= 65)
          return 'Endividamento típico para utilities - necessário para financiar infraestrutura.'
      }
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 1)
          return `Dívida/EBITDA aumentou ${delta.toFixed(1)}x. Monitorar capacidade de geração de caixa.`
        if (delta < -1)
          return `Dívida/EBITDA melhorou ${Math.abs(delta).toFixed(1)}x. Redução do risco financeiro.`
      }

      if (!isNaN(atual)) {
        if (atual > 6)
          return 'Múltiplo elevado indica alto endividamento relativo à capacidade de geração de caixa.'
        if (atual < 3) return 'Múltiplo conservador proporciona boa margem de segurança financeira.'
        if (atual >= 4 && atual <= 5.5)
          return 'Múltiplo adequado para utilities com fluxos de caixa estáveis.'
      }
      return ''
    },
  },
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 1)
          return `Cobertura melhorou ${delta.toFixed(1)}x. Fortalecimento da segurança financeira.`
        if (delta < -1)
          return `Cobertura deteriorou ${Math.abs(delta).toFixed(1)}x. Aumento do risco de stress financeiro.`
      }

      if (!isNaN(atual)) {
        if (atual > 5)
          return 'Cobertura excelente proporciona segurança financeira sólida mesmo em cenários adversos.'
        if (atual < 2)
          return 'Cobertura baixa aumenta significativamente o risco de dificuldades financeiras.'
        if (atual >= 2.5 && atual <= 4)
          return 'Cobertura adequada para utilities com fluxos previsíveis.'
      }
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v > 1.5)
          return 'Liquidez alta para utility pode indicar gestão conservadora ou acúmulo de caixa para investimentos.'
        if (v < 0.8) return 'Liquidez baixa pode indicar gestão agressiva de working capital.'
        if (v >= 1.0 && v <= 1.3)
          return 'Liquidez adequada para utilities com fluxos de caixa previsíveis.'
      }
  ...
  // === EFICIÊNCIA OPERACIONAL ===
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        ...
        if (v < 0.25)
          return 'Giro baixo pode indicar sobrecapacidade, ativos subutilizados ou investimentos recentes.'
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 5)
          return `CapEx aumentou ${delta.toFixed(1)}pp. Pode indicar ciclo de investimentos ou modernização.`
        if (delta < -5)
          return `CapEx reduziu ${Math.abs(delta).toFixed(1)}pp. Pode indicar fim de ciclo de investimentos.`
      }

      if (!isNaN(atual)) {
        if (atual > 30)
          return 'CapEx muito alto pode pressionar fluxo de caixa e sustentabilidade dos dividendos.'
        if (atual < 10)
          return 'CapEx baixo pode indicar falta de investimento em manutenção ou modernização.'
        if (atual >= 15 && atual <= 25)
          return 'CapEx equilibrado permite manutenção e crescimento da infraestrutura.'
      }
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v > 25)
          return 'Ativos envelhecidos podem necessitar de CapEx significativo para modernização.'
        if (v < 10)
          return 'Ativos novos indicam infraestrutura moderna com menor necessidade de manutenção.'
        if (v >= 15 && v <= 20)
          return 'Idade adequada com equilíbrio entre eficiência e necessidade de investimentos.'
      }
  ...
  // === CRESCIMENTO ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 3)
          return `Aceleração no crescimento (+${delta.toFixed(1)}pp). Pode indicar expansão ou aumentos tarifários.`
        if (delta < -3)
          return `Desaceleração no crescimento (${delta.toFixed(1)}pp). Verificar fatores regulatórios ou econômicos.`
      }

      if (!isNaN(atual)) {
        if (atual > 8)
          return 'Crescimento alto para utility pode indicar expansão territorial ou aumentos tarifários.'
        if (atual < 1) return 'Crescimento baixo é típico para utilities em mercados maduros.'
        if (atual >= 3 && atual <= 6)
          return 'Crescimento saudável para utilities balanceando expansão e estabilidade.'
      }
      return ''
    },
  },
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v > 6)
          return 'Crescimento forte da rate base indica expansão significativa da infraestrutura.'
        if (v < 2)
          return 'Crescimento baixo pode indicar mercado maduro ou restrições regulatórias.'
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        ...
        if (Math.abs(delta) > 100000000) {
          ...
          if (delta > 0)
            return `FCF melhorou ${deltaFormatted}M. Fortalecimento da capacidade de autofinanciamento.`
      ...
      if (!isNaN(atual)) {
        if (atual > 0)
          return 'FCF positivo indica capacidade de autofinanciamento e sustentabilidade dos dividendos.'
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v > 85)
          return 'Fator de capacidade excelente indica alta eficiência operacional da geração.'
        if (v < 60)
          return 'Fator baixo pode indicar problemas operacionais ou sazonalidade elevada.'
        if (v >= 70 && v <= 80)
          return 'Fator de capacidade adequado para a maioria das tecnologias.'
      }
  ...
  },
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v > 60)
          return 'Alto percentual de renováveis fortalece perfil ESG e reduz riscos regulatórios.'
        if (v < 20)
          return 'Baixo percentual pode criar pressão regulatória para transição energética.'
  ...
  // === VALUATION VS FUNDAMENTALS ===
  {
    ...
    explicacaoCustom: ({ valor }) => {
      ...
      if (!isNaN(v)) {
        if (v > 1.2)
          return 'DCF sugere valor intrínseco significativamente acima do preço atual - possível oportunidade.'
  ...
  // === CORE FUNDAMENTAIS (peso alto) ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        ...
        if (delta < -2)
          return `ROIC deteriorou ${Math.abs(delta).toFixed(1)}pp - pressão na rentabilidade.`
      }
      if (!isNaN(atual)) {
  ...
  // === COMMUNICATION SERVICES ESPECÍFICOS (peso muito alto) ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        ...
        if (delta < -5)
          return `User growth desacelerou ${Math.abs(delta).toFixed(1)}pp - saturação/competição.`
      }
      if (!isNaN(atual)) {
  ...
  // === MÚLTIPLOS (peso médio) ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta < -5)
          return `P/L reduziu ${Math.abs(delta).toFixed(1)}x - pode indicar oportunidade.`
...

  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta < -1)
          return `P/S reduziu ${Math.abs(delta).toFixed(1)}x - pode indicar oportunidade.`
  ...
  // === CASH FLOW (peso alto) ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 50000000)
          return `FCF melhorou (+${(delta / 1000000).toFixed(0)}M) - fortalece posição.`
        if (delta < -50000000)
          return `FCF deteriorou (${(delta / 1000000).toFixed(0)}M) - pressão nos investimentos.`
      }
      if (!isNaN(atual)) {
  ...
  // === CONTENT INVESTMENT (setor específico) ===
  {
    ...
    explicacaoCustom: ({ valor, valorAnterior }) => {
      ...
      if (!isNaN(atual) && !isNaN(anterior)) {
        const delta = atual - anterior
        if (delta > 3)
          return `Investment em conteúdo aumentou ${delta.toFixed(1)}pp - apostando em diferenciação.`
        if (delta < -3)
          return `Investment reduziu ${Math.abs(delta).toFixed(1)}pp - focando em rentabilidade.`
      }
      if (!isNaN(atual)) {
        if (atual > 25)
          return 'Alto investimento pode impulsionar crescimento mas pressiona margens.'
