// src/features/creators/types/content.ts - Legacy content types for creator public profile
...
export function resolvePlaylists(playlists: Playlist[], creator: Creator): PlaylistResolved[] {
