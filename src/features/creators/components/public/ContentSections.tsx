  ...
  return (
    <>
      {contentVisibility?.playlists?.regular && creatorData.mainPlaylist && (
        <MainPlaylistSection playlists={[creatorData.mainPlaylist]} getEmbedUrl={getEmbedUrl} />
      )}
      ...
      {contentVisibility?.files && <DocumentsSection files={creatorData.documentsResolved ?? []} />}

      {contentVisibility?.events && (
        <EventsSection events={creatorData.eventsResolved ?? []} onEventClick={handleEventClick} />
      )}
    </>
  )
}
