// components/creators/marketing/estatisticas/PlaylistsStats.tsx
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      ...
      <Card>
        ...
        <CardContent>
          ...
          <div className="text-sm text-muted-foreground">{mockPlaylistStats.mostPopular.views} visualizações</div>
        </CardContent>
      </Card>
