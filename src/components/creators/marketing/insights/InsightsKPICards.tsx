// components/creators/marketing/insights/InsightsKPICards.tsx
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      <Card>
        ...
        <CardContent className="text-2xl font-bold">{totalImpressions.toLocaleString()}</CardContent>
      </Card>
        ...
        <Card>
          ...
          <CardContent className="text-2xl font-bold">{totalConversions.toLocaleString()}</CardContent>
        </Card>
