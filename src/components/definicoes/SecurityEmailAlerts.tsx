...
export default function SecurityEmailAlerts() {
  ...
  return (
    <div className="space-y-2">
      ...
      <p className="text-sm text-muted-foreground">Recebe alertas por email quando algo importante acontece.</p>
      ...
      <div className="space-y-3 mt-4">
        ...
        <div className="flex items-center justify-between">
          ...
          <Switch checked={alerts.passwordChange} onCheckedChange={() => toggle("passwordChange")} />
        </div>
        <div className="flex items-center justify-between">
