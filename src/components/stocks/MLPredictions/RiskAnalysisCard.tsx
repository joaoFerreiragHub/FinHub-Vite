    ...
    <Card className="border-yellow-200 bg-gradient-to-br from-yellow-50 to-orange-50">
      ...
      {expanded && (
        <CardContent>
          ...
          {data.riskFactors.map((risk: { factor: string; severity: string; impact: number; description: string }, idx: number) => (
              <div key={idx} className="bg-white rounded-lg p-4 border border-yellow-100 hover:shadow-md transition-shadow">
