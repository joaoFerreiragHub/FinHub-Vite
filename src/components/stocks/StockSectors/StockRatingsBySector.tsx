  ...
  return (
    ...
    {setor === 'Financial Services'&& (
      <RatingsFinancials
        ...
        roe={indicadores['ROE'] ?? '0'}
        roeAnoAnterior={indicadores['ROE (Y-1)'] ?? indicadores['ROE_anterior'] ?? indicadores['ROE (Ano Anterior)']}
        eficiencia={indicadores['Eficiência'] ?? indicadores['Índice de Eficiência'] ?? '0'}
        eficienciaAnoAnterior={indicadores['Eficiência (Y-1)'] ?? indicadores['Índice de Eficiência (Y-1)'] ?? indicadores['Eficiência_anterior'] ?? indicadores['Índice de Eficiência_anterior']}
        nim={indicadores['NIM'] ?? indicadores['Margem Financeira'] ?? indicadores['Margem Financeira Líquida'] ?? '0'}
        nimAnoAnterior={indicadores['NIM (Y-1)'] ?? indicadores['Margem Financeira (Y-1)'] ?? indicadores['Margem Financeira Líquida (Y-1)'] ?? indicadores['NIM_anterior'] ?? indicadores['Margem Financeira_anterior']}

        // Solidez e Capitalização
        basileia={indicadores['Basileia'] ?? indicadores['Índice de Basileia'] ?? '0'}
        basileiaAnoAnterior={indicadores['Basileia (Y-1)'] ?? indicadores['Índice de Basileia (Y-1)'] ?? indicadores['Basileia_anterior'] ?? indicadores['Índice de Basileia_anterior']}
        tier1={indicadores['Tier 1'] ?? indicadores['Capital Principal'] ?? '0'}
        tier1AnoAnterior={indicadores['Tier 1 (Y-1)'] ?? indicadores['Capital Principal (Y-1)'] ?? indicadores['Tier 1_anterior'] ?? indicadores['Capital Principal_anterior']}

        // Estrutura de Capital e Risco
        alavancagem={indicadores['Alavancagem'] ?? indicadores['Índice de Alavancagem'] ?? '0'}
        alavancagemAnoAnterior={indicadores['Alavancagem (Y-1)'] ?? indicadores['Índice de Alavancagem (Y-1)'] ?? indicadores['Alavancagem_anterior'] ?? indicadores['Índice de Alavancagem_anterior']}
        liquidez={indicadores['Liquidez'] ?? indicadores['Liquidez Corrente'] ?? '0'}
        liquidezAnoAnterior={indicadores['Liquidez (Y-1)'] ?? indicadores['Liquidez Corrente (Y-1)'] ?? indicadores['Liquidez_anterior'] ?? indicadores['Liquidez Corrente_anterior']}
        inadimplencia={indicadores['Inadimplência'] ?? indicadores['Taxa de Inadimplência'] ?? '0'}
        inadimplenciaAnoAnterior={indicadores['Inadimplência (Y-1)'] ?? indicadores['Taxa de Inadimplência (Y-1)'] ?? indicadores['Inadimplência_anterior'] ?? indicadores['Taxa de Inadimplência_anterior']}
        cobertura={indicadores['Cobertura'] ?? indicadores['Cobertura de Provisões'] ?? '0'}
        coberturaAnoAnterior={indicadores['Cobertura (Y-1)'] ?? indicadores['Cobertura de Provisões (Y-1)'] ?? indicadores['Cobertura_anterior'] ?? indicadores['Cobertura de Provisões_anterior']}

        // Múltiplos de Avaliação
        pl={indicadores['P/L'] ?? '0'}
        plAnoAnterior={indicadores['P/L (Y-1)'] ?? indicadores['P/L_anterior'] ?? indicadores['P/L (Ano Anterior)']}
        pvpa={indicadores['P/VPA'] ?? '0'}
        pvpaAnoAnterior={indicadores['P/VPA (Y-1)'] ?? indicadores['P/VPA_anterior'] ?? indicadores['P/VPA (Ano Anterior)']}

        // Dividendos e Retorno
        dividendYield={indicadores['Dividend Yield'] ?? '0'}
        dividendYieldAnoAnterior={indicadores['Dividend Yield (Y-1)'] ?? indicadores['Dividend Yield_anterior'] ?? indicadores['Dividend Yield (Ano Anterior)']}
        payoutRatio={indicadores['Payout Ratio'] ?? '0'}
        payoutRatioAnoAnterior={indicadores['Payout Ratio (Y-1)'] ?? indicadores['Payout Ratio_anterior'] ?? indicadores['Payout Ratio (Ano Anterior)']}
        ...
        ldrAnoAnterior={indicadores['LDR_anterior'] ?? indicadores['Loan-to-Deposit Ratio_anterior']}
        beta={indicadores['Beta'] ?? '0'}
        betaAnoAnterior={indicadores['Beta (Y-1)'] ?? indicadores['Beta_anterior'] ?? indicadores['Beta (Ano Anterior)']}
        leveredDcf={indicadores['Levered DCF'] ?? indicadores['DCF'] ?? indicadores['Valuation (DCF)'] ?? '0'}
        ...
        precoAtualAnoAnterior={indicadores['Preço Atual_anterior'] ?? indicadores['Preço_anterior']}
        ...
        roaAnoAnterior={indicadores['ROA_anterior'] ?? indicadores['Retorno sobre Ativos_anterior']}
        custoCredito={indicadores['Custo do Crédito'] ?? indicadores['Custo do Risco']}
        custoCreditoAnoAnterior={indicadores['Custo do Crédito_anterior'] ?? indicadores['Custo do Risco_anterior']}
        crescimentoCarteira={indicadores['Crescimento Carteira'] ?? indicadores['Crescimento da Carteira']}
        crescimentoCarteiraAnoAnterior={indicadores['Crescimento Carteira_anterior'] ?? indicadores['Crescimento da Carteira_anterior']}
      />
    )}
    {setor === "Real Estate" && (
      <RatingsREITs
    ...
    {setor === "Consumer Defensive" && (
      <RatingsConsumerDefensive
        ...
        peAnoAnterior={indicadores['P/L (Y-1)'] ?? indicadores['P/L_anterior'] ?? indicadores['P/L (Ano Anterior)']}
        pb={indicadores['P/VPA'] ?? '0'}
        pbAnoAnterior={indicadores['P/VPA (Y-1)'] ?? indicadores['P/VPA_anterior'] ?? indicadores['P/VPA (Ano Anterior)']}
        ps={indicadores['P/S'] ?? '0'}
        psAnoAnterior={indicadores['P/S (Y-1)'] ?? indicadores['P/S_anterior'] ?? indicadores['P/S (Ano Anterior)']}
        roe={indicadores['ROE'] ?? '0'}
        roeAnoAnterior={indicadores['ROE (Y-1)'] ?? indicadores['ROE_anterior'] ?? indicadores['ROE (Ano Anterior)']}
        grossMargin={indicadores['Margem Bruta'] ?? '0'}
        grossMarginAnoAnterior={indicadores['Margem Bruta (Y-1)'] ?? indicadores['Margem Bruta_anterior']}
        ebitdaMargin={indicadores['Margem EBITDA'] ?? '0'}
        ebitdaMarginAnoAnterior={indicadores['Margem EBITDA (Y-1)'] ?? indicadores['Margem EBITDA_anterior']}
        receitaCagr3y={indicadores['Crescimento da Receita'] ?? indicadores['CAGR Receita 3Y'] ?? '0'}
        receitaCagr3yAnoAnterior={indicadores['Crescimento da Receita (Y-1)'] ?? indicadores['CAGR Receita 3Y (Y-1)'] ?? indicadores['Crescimento da Receita_anterior']}
        payoutRatio={indicadores['Payout Ratio'] ?? '0'}
        payoutRatioAnoAnterior={indicadores['Payout Ratio (Y-1)'] ?? indicadores['Payout Ratio_anterior'] ?? indicadores['Payout Ratio (Ano Anterior)']}
        dividendYield={indicadores['Dividend Yield'] ?? '0'}
        dividendYieldAnoAnterior={indicadores['Dividend Yield (Y-1)'] ?? indicadores['Dividend Yield_anterior'] ?? indicadores['Dividend Yield (Ano Anterior)']}
        ...
        margemLiquida={indicadores['Margem Líquida'] ?? '0'}
        margemLiquidaAnoAnterior={indicadores['Margem Líquida (Y-1)'] ?? indicadores['Margem Líquida_anterior']}
        margemOperacional={indicadores['Margem Operacional'] ?? '0'}
        margemOperacionalAnoAnterior={indicadores['Margem Operacional (Y-1)'] ?? indicadores['Margem Operacional_anterior']}
        crescimentoReceita={indicadores['Crescimento Receita'] ?? '0'}
        crescimentoReceitaAnoAnterior={indicadores['Crescimento Receita (Y-1)'] ?? indicadores['Crescimento Receita_anterior']}
        consistenciaReceita={indicadores['Consistência Receita'] ?? '0'}
        consistenciaReceitaAnoAnterior={indicadores['Consistência Receita (Y-1)'] ?? indicadores['Consistência Receita_anterior']}
        dividaEbitda={indicadores['Dívida/EBITDA'] ?? '0'}
        dividaEbitdaAnoAnterior={indicadores['Dívida/EBITDA (Y-1)'] ?? indicadores['Dívida/EBITDA_anterior']}
        coberturaJuros={indicadores['Cobertura de Juros'] ?? '0'}
        coberturaJurosAnoAnterior={indicadores['Cobertura de Juros (Y-1)'] ?? indicadores['Cobertura de Juros_anterior']}
        liquidezCorrente={indicadores['Liquidez Corrente'] ?? '0'}
        liquidezCorrenteAnoAnterior={indicadores['Liquidez Corrente (Y-1)'] ?? indicadores['Liquidez Corrente_anterior']}
        debtEquity={indicadores['Dívida/Patrimônio'] ?? '0'}
        debtEquityAnoAnterior={indicadores['Dívida/Patrimônio (Y-1)'] ?? indicadores['Dívida/Patrimônio_anterior']}
        freeCashFlow={indicadores['Free Cash Flow'] ?? '0'}
        freeCashFlowAnoAnterior={indicadores['Free Cash Flow (Y-1)'] ?? indicadores['Free Cash Flow_anterior']}
        ...
        workingCapitalTurnoverAnoAnterior={indicadores['Working Capital Turnover (Y-1)'] ?? indicadores['Working Capital Turnover_anterior']}
        inventoryTurnover={indicadores['Inventory Turnover'] ?? '0'}
        inventoryTurnoverAnoAnterior={indicadores['Inventory Turnover (Y-1)'] ?? indicadores['Inventory Turnover_anterior']}
        dividendGrowth={indicadores['Crescimento Dividendos'] ?? '0'}
        dividendGrowthAnoAnterior={indicadores['Crescimento Dividendos (Y-1)'] ?? indicadores['Crescimento Dividendos_anterior']}
        ...
        leveredDcfAnoAnterior={indicadores['Levered DCF (Y-1)'] ?? indicadores['Levered DCF_anterior']}
        precoAtual={indicadores['Preço Atual'] ?? '0'}
        precoAtualAnoAnterior={indicadores['Preço Atual (Y-1)'] ?? indicadores['Preço Atual_anterior']}
    ...
    {setor === 'Industrials' && (
      <RatingsIndustrials
        ...
        margemEbitdaAnoAnterior={indicadores['Margem EBITDA_anterior'] ?? indicadores['Margem EBITDA (Ano Anterior)']}
        roicAnoAnterior={indicadores['ROIC_anterior'] ?? indicadores['ROIC (Ano Anterior)']}
        alavancagemAnoAnterior={indicadores['Alavancagem Financeira_anterior'] ?? indicadores['Alavancagem Financeira (Ano Anterior)']}
        coberturaJurosAnoAnterior={indicadores['Cobertura de Juros_anterior'] ?? indicadores['Cobertura de Juros (Ano Anterior)']}
        liquidezCorrenteAnoAnterior={indicadores['Liquidez Corrente_anterior'] ?? indicadores['Liquidez Corrente (Ano Anterior)']}
        rotatividadeEstoquesAnoAnterior={indicadores['Rotatividade de Estoques_anterior'] ?? indicadores['Rotatividade de Estoques (Ano Anterior)']}
        ...
        dividendYieldAnoAnterior={indicadores['Dividend Yield_anterior'] ?? indicadores['Dividend Yield (Ano Anterior)']}
        betaAnoAnterior={indicadores['Beta_anterior'] ?? indicadores['Beta (Ano Anterior)']}
        giroAtivoAnoAnterior={indicadores['Giro do Ativo_anterior'] ?? indicadores['Giro do Ativo (Ano Anterior)']}
        ...
        margemLiquidaAnoAnterior={indicadores['Margem Líquida_anterior'] ?? indicadores['Margem Líquida (Ano Anterior)']}
    ...
    {setor === 'Energy' && (
      <RatingsEnergy
        ...
        roeAnoAnterior={indicadores['ROE (Y-1)'] ?? indicadores['ROE_anterior'] ?? indicadores['ROE (Ano Anterior)']}
        roic={indicadores['ROIC'] ?? '0'}
        roicAnoAnterior={indicadores['ROIC (Y-1)'] ?? indicadores['ROIC_anterior'] ?? indicadores['ROIC (Ano Anterior)']}

        // Margens e Eficiência
        margemEbitda={indicadores['Margem EBITDA'] ?? '0'}
        margemEbitdaAnoAnterior={indicadores['Margem EBITDA (Y-1)'] ?? indicadores['Margem EBITDA_anterior']}
        margemBruta={indicadores['Margem Bruta'] ?? '0'}
        margemBrutaAnoAnterior={indicadores['Margem Bruta (Y-1)'] ?? indicadores['Margem Bruta_anterior']}
        margemLiquida={indicadores['Margem Líquida'] ?? '0'}
        margemLiquidaAnoAnterior={indicadores['Margem Líquida (Y-1)'] ?? indicadores['Margem Líquida_anterior']}

        // Estrutura de Capital e Solvência
        dividaEbitda={indicadores['Endividamento'] ?? indicadores['Dívida/EBITDA'] ?? '0'}
        dividaEbitdaAnoAnterior={indicadores['Endividamento (Y-1)'] ?? indicadores['Dívida/EBITDA (Y-1)'] ?? indicadores['Endividamento_anterior']}
        coberturaJuros={indicadores['Cobertura de Juros'] ?? '0'}
        coberturaJurosAnoAnterior={indicadores['Cobertura de Juros (Y-1)'] ?? indicadores['Cobertura de Juros_anterior']}
        liquidezCorrente={indicadores['Liquidez Corrente'] ?? '0'}
        liquidezCorrenteAnoAnterior={indicadores['Liquidez Corrente (Y-1)'] ?? indicadores['Liquidez Corrente_anterior']}
        debtEquity={indicadores['Dívida/Patrimônio'] ?? indicadores['Debt/Equity'] ?? '0'}
        debtEquityAnoAnterior={indicadores['Dívida/Patrimônio (Y-1)'] ?? indicadores['Debt/Equity (Y-1)'] ?? indicadores['Dívida/Patrimônio_anterior']}

        // Fluxo de Caixa e Investimentos
        freeCashFlow={indicadores['Fluxo de Caixa Livre'] ?? indicadores['Free Cash Flow'] ?? indicadores['FCF'] ?? '0'}
        freeCashFlowAnoAnterior={indicadores['Fluxo de Caixa Livre (Y-1)'] ?? indicadores['Free Cash Flow (Y-1)'] ?? indicadores['FCF (Y-1)'] ?? indicadores['Fluxo de Caixa Livre_anterior']}
        capexRevenue={indicadores['CapEx/Receita'] ?? indicadores['CapEx/Revenue'] ?? '0'}
        capexRevenueAnoAnterior={indicadores['CapEx/Receita (Y-1)'] ?? indicadores['CapEx/Revenue (Y-1)'] ?? indicadores['CapEx/Receita_anterior']}
        fcfYield={indicadores['FCF Yield'] ?? '0'}
        fcfYieldAnoAnterior={indicadores['FCF Yield (Y-1)'] ?? indicadores['FCF Yield_anterior']}
        ...
        betaAnoAnterior={indicadores['Beta (Y-1)'] ?? indicadores['Beta_anterior'] ?? indicadores['Beta (Ano Anterior)']}
        leveredDcf={indicadores['Levered DCF'] ?? indicadores['DCF'] ?? indicadores['Valuation (DCF)'] ?? '0'}
        leveredDcfAnoAnterior={indicadores['Levered DCF (Y-1)'] ?? indicadores['DCF (Y-1)'] ?? indicadores['Levered DCF_anterior']}
        precoAtual={indicadores['Preço Atual'] ?? indicadores['Preço'] ?? '0'}
        precoAtualAnoAnterior={indicadores['Preço Atual (Y-1)'] ?? indicadores['Preço (Y-1)'] ?? indicadores['Preço Atual_anterior']}
        ...
        reservasProvadasAnoAnterior={indicadores['Reservas Provadas_anterior'] ?? indicadores['Proven Reserves_anterior']}
        custoProducao={indicadores['Custo de Produção'] ?? indicadores['Production Cost']}
        custoProducaoAnoAnterior={indicadores['Custo de Produção_anterior'] ?? indicadores['Production Cost_anterior']}
        breakEvenPrice={indicadores['Break-even Price'] ?? indicadores['Preço de Equilíbrio']}
        breakEvenPriceAnoAnterior={indicadores['Break-even Price_anterior'] ?? indicadores['Preço de Equilíbrio_anterior']}
      />
    )}
    {setor === "Consumer Cyclical" && (
      <RatingsConsumerCyclical
        ...
        // Margens e Eficiência
        grossMargin={indicadores['Margem Bruta'] ?? '0'}
        grossMarginAnoAnterior={indicadores['Margem Bruta (Y-1)'] ?? indicadores['Margem Bruta_anterior'] ?? indicadores['Margem Bruta (Ano Anterior)']}
        ebitdaMargin={indicadores['Margem EBITDA'] ?? '0'}
        ebitdaMarginAnoAnterior={indicadores['Margem EBITDA (Y-1)'] ?? indicadores['Margem EBITDA_anterior'] ?? indicadores['Margem EBITDA (Ano Anterior)']}
        margemLiquida={indicadores['Margem Líquida'] ?? '0'}
        margemLiquidaAnoAnterior={indicadores['Margem Líquida (Y-1)'] ?? indicadores['Margem Líquida_anterior'] ?? indicadores['Margem Líquida (Ano Anterior)']}
        margemOperacional={indicadores['Margem Operacional'] ?? '0'}
        margemOperacionalAnoAnterior={indicadores['Margem Operacional (Y-1)'] ?? indicadores['Margem Operacional_anterior'] ?? indicadores['Margem Operacional (Ano Anterior)']}

        // Crescimento e Performance
        receitaCagr3y={indicadores['Crescimento da Receita (3Y)'] ?? indicadores['CAGR Receita 3Y'] ?? indicadores['Crescimento da Receita'] ?? '0'}
        receitaCagr3yAnoAnterior={indicadores['Crescimento da Receita (3Y) (Y-1)'] ?? indicadores['CAGR Receita 3Y (Y-1)'] ?? indicadores['Crescimento da Receita_anterior']}
        crescimentoReceita={indicadores['Crescimento Receita'] ?? indicadores['Crescimento da Receita'] ?? '0'}
        crescimentoReceitaAnoAnterior={indicadores['Crescimento Receita (Y-1)'] ?? indicadores['Crescimento da Receita (Y-1)'] ?? indicadores['Crescimento Receita_anterior']}
        crescimentoEbitda={indicadores['Crescimento EBITDA'] ?? '0'}
        crescimentoEbitdaAnoAnterior={indicadores['Crescimento EBITDA (Y-1)'] ?? indicadores['Crescimento EBITDA_anterior']}

        // Estrutura de Capital e Solvência
        endividamento={indicadores['Endividamento'] ?? indicadores['Dívida/EBITDA'] ?? '0'}
        endividamentoAnoAnterior={indicadores['Endividamento (Y-1)'] ?? indicadores['Dívida/EBITDA (Y-1)'] ?? indicadores['Endividamento_anterior']}
        coberturaJuros={indicadores['Cobertura de Juros'] ?? '0'}
        coberturaJurosAnoAnterior={indicadores['Cobertura de Juros (Y-1)'] ?? indicadores['Cobertura de Juros_anterior']}
        liquidezCorrente={indicadores['Liquidez Corrente'] ?? '0'}
        liquidezCorrenteAnoAnterior={indicadores['Liquidez Corrente (Y-1)'] ?? indicadores['Liquidez Corrente_anterior']}
        ...
        rotatividadeEstoques={indicadores['Rotatividade de Estoques'] ?? indicadores['Inventory Turnover'] ?? '0'}
        rotatividadeEstoquesAnoAnterior={indicadores['Rotatividade de Estoques (Y-1)'] ?? indicadores['Inventory Turnover (Y-1)'] ?? indicadores['Rotatividade de Estoques_anterior']}
        workingCapitalTurnover={indicadores['Working Capital Turnover'] ?? '0'}
        workingCapitalTurnoverAnoAnterior={indicadores['Working Capital Turnover (Y-1)'] ?? indicadores['Working Capital Turnover_anterior']}
        assetTurnover={indicadores['Asset Turnover'] ?? '0'}
        assetTurnoverAnoAnterior={indicadores['Asset Turnover (Y-1)'] ?? indicadores['Asset Turnover_anterior']}
        receivablesTurnover={indicadores['Receivables Turnover'] ?? '0'}
        receivablesTurnoverAnoAnterior={indicadores['Receivables Turnover (Y-1)'] ?? indicadores['Receivables Turnover_anterior']}

        // Fluxo de Caixa
        freeCashFlow={indicadores['Free Cash Flow'] ?? indicadores['FCF'] ?? '0'}
        freeCashFlowAnoAnterior={indicadores['Free Cash Flow (Y-1)'] ?? indicadores['FCF (Y-1)'] ?? indicadores['Free Cash Flow_anterior']}
        fcfYield={indicadores['FCF Yield'] ?? '0'}
        fcfYieldAnoAnterior={indicadores['FCF Yield (Y-1)'] ?? indicadores['FCF Yield_anterior']}
        capexRevenue={indicadores['CapEx/Receita'] ?? indicadores['CapEx Ratio'] ?? '0'}
        capexRevenueAnoAnterior={indicadores['CapEx/Receita (Y-1)'] ?? indicadores['CapEx Ratio (Y-1)'] ?? indicadores['CapEx/Receita_anterior']}
        ...
        beta={indicadores['Beta'] ?? '0'}
        betaAnoAnterior={indicadores['Beta (Y-1)'] ?? indicadores['Beta_anterior'] ?? indicadores['Beta (Ano Anterior)']}
        leveredDcf={indicadores['Valuation (DCF)'] ?? indicadores['Levered DCF'] ?? indicadores['DCF'] ?? '0'}
        leveredDcfAnoAnterior={indicadores['Valuation (DCF) (Y-1)'] ?? indicadores['Levered DCF (Y-1)'] ?? indicadores['DCF (Y-1)'] ?? indicadores['Levered DCF_anterior']}
        precoAtual={indicadores['Preço Atual'] ?? indicadores['Preço'] ?? '0'}
        precoAtualAnoAnterior={indicadores['Preço Atual (Y-1)'] ?? indicadores['Preço (Y-1)'] ?? indicadores['Preço Atual_anterior']}
        ...
        seasonalityIndexAnoAnterior={indicadores['Sazonalidade (Y-1)'] ?? indicadores['Seasonality Index (Y-1)'] ?? indicadores['Sazonalidade_anterior']}
        consumerConfidence={indicadores['Confiança do Consumidor'] ?? indicadores['Consumer Confidence']}
        consumerConfidenceAnoAnterior={indicadores['Confiança do Consumidor (Y-1)'] ?? indicadores['Consumer Confidence (Y-1)'] ?? indicadores['Confiança do Consumidor_anterior']}
        marketShare={indicadores['Market Share'] ?? indicadores['Participação de Mercado']}
        marketShareAnoAnterior={indicadores['Market Share (Y-1)'] ?? indicadores['Participação de Mercado (Y-1)'] ?? indicadores['Market Share_anterior']}
      />
    )}
    {setor === "Basic Materials" && (
      <RatingsBasicMaterials
        ...
        dividaEbitdaAnoAnterior={indicadores['Dívida/EBITDA (Y-1)'] ?? indicadores['Endividamento (Y-1)'] ?? indicadores['Dívida/EBITDA_anterior']}
        coberturaJuros={indicadores['Cobertura de Juros'] ?? '0'}
        coberturaJurosAnoAnterior={indicadores['Cobertura de Juros (Y-1)'] ?? indicadores['Cobertura de Juros_anterior']}
        liquidezCorrente={indicadores['Liquidez Corrente'] ?? '0'}
        liquidezCorrenteAnoAnterior={indicadores['Liquidez Corrente (Y-1)'] ?? indicadores['Liquidez Corrente_anterior']}
        ...
        freeCashFlow={indicadores['Free Cash Flow'] ?? indicadores['Fluxo de Caixa Livre'] ?? indicadores['FCF'] ?? '0'}
        freeCashFlowAnoAnterior={indicadores['Free Cash Flow (Y-1)'] ?? indicadores['Fluxo de Caixa Livre (Y-1)'] ?? indicadores['FCF (Y-1)'] ?? indicadores['Free Cash Flow_anterior']}
        capexRevenue={indicadores['CapEx/Receita'] ?? indicadores['CapEx/Revenue'] ?? '0'}
        capexRevenueAnoAnterior={indicadores['CapEx/Receita (Y-1)'] ?? indicadores['CapEx/Revenue (Y-1)'] ?? indicadores['CapEx/Receita_anterior']}
        fcfYield={indicadores['FCF Yield'] ?? '0'}
        fcfYieldAnoAnterior={indicadores['FCF Yield (Y-1)'] ?? indicadores['FCF Yield_anterior']}
        workingCapitalTurnover={indicadores['Working Capital Turnover'] ?? indicadores['Giro Capital de Giro'] ?? '0'}
        workingCapitalTurnoverAnoAnterior={indicadores['Working Capital Turnover (Y-1)'] ?? indicadores['Giro Capital de Giro (Y-1)'] ?? indicadores['Working Capital Turnover_anterior']}
        ...
        inventoryTurnoverAnoAnterior={indicadores['Inventory Turnover_anterior'] ?? indicadores['Giro de Inventário_anterior']}
        assetTurnover={indicadores['Asset Turnover'] ?? indicadores['Giro de Ativos']}
        assetTurnoverAnoAnterior={indicadores['Asset Turnover_anterior'] ?? indicadores['Giro de Ativos_anterior']}
        capacityUtilization={indicadores['Capacity Utilization'] ?? indicadores['Utilização da Capacidade']}
        capacityUtilizationAnoAnterior={indicadores['Capacity Utilization_anterior'] ?? indicadores['Utilização da Capacidade_anterior']}
      />
    )}
    {setor === 'Utilities' && (
      <RatingsUtilities
        ...
        dividendCagr5y={indicadores['Dividend CAGR 5Y'] ?? indicadores['CAGR Dividendos 5A'] ?? '0'}
        dividendCagr5yAnoAnterior={indicadores['Dividend CAGR 5Y (Y-1)'] ?? undefined}

        // Estrutura Financeira
        endividamento={indicadores['Endividamento'] ?? indicadores['Dívida Total/Patrimônio'] ?? '0'}
        ...
        capexOverRevenue={indicadores['CapEx/Receita'] ?? indicadores['Investimentos/Receita'] ?? '0'}
      ...
      {setor === "Communication Services" && (
        <RatingsCommunication
          ...
          userGrowthAnoAnterior={indicadores['Crescimento de Usuários (Y-1)'] ?? indicadores['User Growth (Y-1)'] ?? indicadores['Crescimento de Usuários_anterior']}
          arpu={indicadores['ARPU'] ?? indicadores['Receita por Usuário']}
          arpuAnoAnterior={indicadores['ARPU (Y-1)'] ?? indicadores['Receita por Usuário (Y-1)'] ?? indicadores['ARPU_anterior']}
          churnRate={indicadores['Churn Rate'] ?? indicadores['Taxa de Churn']}
          churnRateAnoAnterior={indicadores['Churn Rate (Y-1)'] ?? indicadores['Taxa de Churn (Y-1)'] ?? indicadores['Churn Rate_anterior']}
          contentInvestment={indicadores['Content Investment'] ?? indicadores['Investimento em Conteúdo']}
          contentInvestmentAnoAnterior={indicadores['Content Investment (Y-1)'] ?? indicadores['Investimento em Conteúdo (Y-1)'] ?? indicadores['Content Investment_anterior']}
        />
      )}
    </>
  )
