    ...
    <div className="w-full h-[300px]">
      ...
      <ResponsiveContainer width="100%" height="100%">
        <LineChart data={mockData} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
          ...
          <Tooltip />
          <Legend />
          <Line type="monotone" dataKey="ROIC" stroke="#10b981" strokeWidth={2} dot={true} name="ROIC" />
          <Line type="monotone" dataKey="WACC" stroke="#ef4444" strokeWidth={2} dot={true} name="WACC" />
        </LineChart>
      </ResponsiveContainer>
    </div>
  )
