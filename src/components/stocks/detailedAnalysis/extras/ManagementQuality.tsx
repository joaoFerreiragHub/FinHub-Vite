    ...
    <Card>
      <CardContent className="space-y-2 p-4">
        ...
        <ul className="text-sm space-y-1">
          <li>Tempo médio no cargo (CEO): <strong>{ceoTenure} anos</strong></li>
          <li>Experiência do CEO: <strong>{ceoExperience}</strong></li>
          <li>Histórico de execução: <strong>{executionScore}/100</strong></li>
        </ul>
      </CardContent>
    </Card>
  )
