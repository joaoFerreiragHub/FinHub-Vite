import { EditBook } from '@/features/creators/dashboard/books'
...
export function Page(props: any) {
  ...
  return (
    <MemoryRouter initialEntries={[`/creators/dashboard/books/${id}/edit`]}>
      <Routes>
        <Route path="/creators/dashboard/books/:id/edit" element={<EditBook />} />
      </Routes>
    </MemoryRouter>
  )
}
